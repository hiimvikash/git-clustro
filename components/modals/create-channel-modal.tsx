...
export const CreateChannelModal = () => {
  ...
  const form = useForm({
    ...
    defaultValues: {
      name: "",
      type: defaultChannelType || ChannelType.TEXT,
    },
  });
  ...
  }, [defaultChannelType, form, isModalOpen])

  const onSubmit = async (values: z.infer<typeof createChannelSchema>) => {
    const data = await createChannel(values, params?.serverId as string);
    form.reset();
    router.refresh();
    onClose();
  };
